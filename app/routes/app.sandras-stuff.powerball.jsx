  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: 24 }}>
      ...
      {r.researchTickets?.length > 0 && (
        <section style={{ marginTop: 28, padding: 20, border: "1px dashed #999", borderRadius: 12 }}>
          <h2>Research-Only Ensemble Tickets</h2>
          <p><strong>Do not interpret these as having a demonstrated predictive advantage.</strong> They are the combinations the experimental ensemble currently scores highest and are shown separately so we can compare future outcomes against the primary baseline.</p>
